        ...
        <div class="container p-4">
            <div class="shadow container form-group bg-secondary text-left text-white p-4 border border-info rounded">
                ...
                <form class="row" method="post" action="#">
                    <div class="form-group col-12 mt-4 border-bottom border-dark">
                        <label class="text-dark" for="HT"><b>HORAS TRABALHADAS NO MÊS</b></label>
                        <input class="bg-dark border-info form-control mb-4 text-secondary" type="text" name="HT" placeholder=" Digite quantas horas trabalhou no mês...">
                    </div>

                    <div class="form-group col-12 mt-4 border-bottom border-dark">
                        <label class="text-dark" for="VH"><b>VALOR HORA TRABALHADAS</b></label>
                        <div class="container input-group-prepend row">
                            <input class="bg-dark border-info form-control mb-4 col-10 text-secondary" type="text" name="VH" placeholder="Digite quanto vale sua hora de serviço...">
                            <div class="bg-dark border-info form-control mb-4 input-group-text col-1 text-secondary">R$</div>
                            <div class="bg-dark border-info form-control mb-4 input-group-text col-1 text-secondary">.00</div>
                        </div>
                    </div>

                    <!-- DESCONTO -->
                    <div class="form-group col-12 mt-4 border-bottom border-dark">
                        <label class="text-dark" for="PD"><b>Percentual de Desconto</b></label>
                        <div class="container input-group-prepend row ">
                            <input class="bg-dark border-info form-control mb-4 col-10 text-secondary" type="text" name="PD" placeholder="Digite o desconto ex: 2...">
                            <div class="bg-dark border-info form-control mb-4 input-group-text col-1 text-secondary">R$</div>
                            <div class="bg-dark border-info form-control mb-4 input-group-text col-1 text-secondary">%</div>
                        </div>
                    </div>


                    <button type="submit" class="btn btn-dark border-info btn-outline-success text-light ml-4">Enviar</button>
                </form>
            </div>
        </div>

        <div class="container p-4">
            <div class="container shadow mb-5 bg-secondary text-left text-white p-4 border border-info rounded">
                <h3 class="text-dark">RESULTADO</h3>
                <p class="bg-dark border border-info rounded p-2 text-secondary">HORAS TRABALHADAS NO MÊS: <?= $HT ?></p>
                <p class="bg-dark border border-info rounded p-2 text-secondary">SALÁRIO BRUTO: <?= "R$" . $SB ?> </p>
                <p class="bg-dark border border-info rounded p-2 text-secondary">DESCONTO: <?= "R$" . $TD ?> </p>
                <p class="bg-dark border border-info rounded p-2 text-secondary">SALÁRIO LÍUIDO: <?= "R$" . $SL ?> </p>
            </div>
        </div>
