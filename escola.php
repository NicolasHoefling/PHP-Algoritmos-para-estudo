            ...
            <nav class="navbar bg-dark navbar-dark border-bottom border-info">
                ...
                <ul class="navbar-nav">
                        <div class=" border-bottom item-center border-info mb-2">  
                            ...
                            <h5  class="mt-2 mb-2"> ATIVIDADE 02</h5>
                    </ul>
            ...
            <div class="container">
                <form action="#" method="$_POST">
                    <div class="form-group col-12 mt-4 border-bottom border-dark">
                        <label class="text-dark"><b>O NÚMERO DA MATRÍCULA</b></label>
                        <input class="bg-dark border-info form-control mb-4 text-secondary" type="text" name="cod" placeholder=" Digite os aqui...">
                    </div>
                ...
                <?php
                    ...
                    $ano = substr($cod, 0,2);
                    $semestre = substr($cod, 2,1);
                    $matricula = substr($cod, 3,4);
                    
                    }
                    ?>
                    <p class="bg-dark border border-info rounded p-2 text-secondary">ANO: <?= $ano ?></p>
                    <p class="bg-dark border border-info rounded p-2 text-secondary">SEMESTRE: <?= $semestre ?> </p>
                    <p class="bg-dark border border-info rounded p-2 text-secondary">MATRICULA: <?= $matricula ?> </p>
	</div>
