...
<header>
            <nav class="navbar bg-dark navbar-dark border-bottom border-info">
                <div class="p-6 text-white rounded ml-5">
                    <H2 class="text-white ">Algoritmo Trabalho</H2>
                </div>
                            ...
                            <div class="row">  
                                ...
                                <li class="nav-item col-2 mb-3">
                                    <button type="button" class="bg-dark btn btn-dark btn-outline-info ">
                                        ...
                                        <a class="nav-link" href="valores.php">Algoritmo Sorteio</a>
                                    </button>
                                </li>
                            </div>
                        </div>
                            <h5  class="mt-2 mb-2"> ATIVIDADE 04</h5>
                    </ul>
    ...
    <div class="container p-3">
        <div class="container p-4">
            <div class="shadow container form-group bg-secondary text-left text-white p-4 border border-info rounded">
                <h3 class="text-dark">SORTEIO</h3>
                        F5 PARA REFAZER O SORTEIO 
                        <p class="bg-dark border border-info rounded p-2 text-secondary mt-3">
                        <?php
$input = array(mt_rand(1,60),  mt_rand(1,60),  mt_rand(1,60),  mt_rand(1,60),  mt_rand(1,60),  mt_rand(1,60));
...
<!--                        
                        <?php
                            ...
                            $numeros = array($v1, $v2, $v3, $v4, $v5, $v6);
                            sort($numeros);
